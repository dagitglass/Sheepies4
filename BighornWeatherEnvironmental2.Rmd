...
ggplot(forfig3, aes(tmax..deg.c., Percentvisited, colour = MountainRange)) + geom_point() + ylab("Percent of desert bighorn that visited water") + xlab("Maximum temperature (°C)") + labs(color = "Mountain Range") + theme(axis.line = element_line(colour = "black")) + 
  theme(panel.background = element_rect(fill = "white"))
