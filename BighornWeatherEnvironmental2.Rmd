...
ggplot(forfig3, aes(tmax..deg.c., Percentvisited, color = MountainRange)) + geom_point() + scale_color_manual(values = c("#00BA38", "#D55E00", "gold1", "#619CFF")) + ylab("Proportion of desert bighorn that visited water") + xlab("Maximum temperature (°C)") + labs(color = "Mountain Range") + theme(axis.line = element_line(colour = "black")) + 
  theme(panel.background = element_rect(fill = "white")) 
