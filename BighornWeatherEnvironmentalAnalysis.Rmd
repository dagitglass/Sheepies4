...
# CMPR Missing between 8/8-8/13
# DF2 = DF1[-c(2),]



# meanpercentbighorn2 <- aggregate(
#   meanpercentbighorn1[, c("NumIndSheep", "TotalNumSheep", "Percentvisited", "Meannumvisits", "sd")],
#   meanpercentbighorn1[, c("Date", "Month", "MtnRange")],
#   FUN = sum,
#   na.rm = TRUE
# )
...
# There were some duplicated rows (probably because I am not using the merge function as efficiently as I could), so I got rid of them
rownames(meanpercentbighorn1) <- seq(length=nrow(meanpercentbighorn1))
meanpercentbighorn1[-c(2, 5, 7, 8, 10, 13, 26, 27, 29, 31, 33, 35, 38,  )]
# DF2 = DF1[-c(2),]
