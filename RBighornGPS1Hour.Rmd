...
longstp <- day1hr[day1hr$stplengthtopo >= 2000, ]
table(longstp$beforevisit)
...
# par(mar=c(4,4,4,4)) Figure 5
par(mar=c(4,4,4,1))
par(mfrow = c(2,2))
boxplot(Closedist ~ Month, data = callmtndistwater2[callmtndistwater2$MountainRange == "Marb", ], ylab = "Distance (m)", main = "Marble", xlab = "Month", axes = F, col = "white", xaxt='n')
box(bty="l")
axis(2, axTicks(2), format(axTicks(2), big.mark = ","))
axis(1, at = c(1, 2, 3, 4), labels = c("May", "Jun", "Jul", "Aug"))

boxplot(Closedist ~ Month, data = callmtndistwater2[callmtndistwater2$MountainRange == "BrsS", ], ylab = "Distance (m)", main = "South Bristol", axes = F, col = "white", xaxt='n')
box(bty="l")
axis(2, axTicks(2), format(axTicks(2), big.mark = ","))
axis(1, at = c(1, 2, 3, 4), labels = c("May", "Jun", "Jul", "Aug"))
...
boxplot(Closedist ~ Month, data = callmtndistwater2[callmtndistwater2$MountainRange == "CMPR", ], ylab = "Distance (m)", main = "Castle Piute", axes = F, col = "white", xaxt='n')
box(bty="l")
axis(2, axTicks(2), format(axTicks(2), big.mark = ","))
axis(1, at = c(1, 2, 3, 4), labels = c("May", "Jun", "Jul", "Aug"))
dev.off()
...
boxplot(stplengthtopo ~ TimeLocal1, data = callmtndistwater2,ylab = "Topographic step length (m)", xlab = "Time of day", col = "white", axes = F)
box(bty="l")
axis(2, axTicks(2), format(axTicks(2), big.mark = ","))
axis(1)
