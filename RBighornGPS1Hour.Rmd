...
allcdi2$Date <- as.Date(allcdi2$Date, format = "%Y-%m-%d")
...
par(mar=c(4,4,4,4))
par(mfrow = c(2,2))
boxplot(Closedist ~ Month, data = callmtndistwater2[callmtndistwater2$MountainRange == "Marb", ], ylab = "Distance (m)", main = "Marbles", xlab = "Month")
boxplot(Closedist ~ Month, data = callmtndistwater2[callmtndistwater2$MountainRange == "BrsS", ], ylab = "Distance (m)", main = "South Bristols")
boxplot(Closedist ~ Month, data = callmtndistwater2[callmtndistwater2$MountainRange == "Nopa", ], ylab = "Distance (m)", main = "Nopah")
boxplot(Closedist ~ Month, data = callmtndistwater2[callmtndistwater2$MountainRange == "CMPR", ], ylab = "Distance (m)", main = "Castle Piutes")
dev.off()
