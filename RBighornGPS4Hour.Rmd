...
cln4hrfix <- cln1hrfix1[((((cln1hrfix1$Hour == 23) | (cln1hrfix1$Hour == 3) | (cln1hrfix1$Hour == 7) | (cln1hrfix1$Hour == 11) | (cln1hrfix1$Hour == 15) | (cln1hrfix1$Hour == 19)) & (cln1hrfix1$Min == 59)) | (((cln1hrfix1$Hour == 0) | (cln1hrfix1$Hour == 4) | (cln1hrfix1$Hour == 8) | (cln1hrfix1$Hour == 12) | (cln1hrfix1$Hour == 16) | (cln1hrfix1$Hour == 20)) & ((cln1hrfix1$Min == 0) | (cln1hrfix1$Min == 1) | (cln1hrfix1$Min == 2) | (cln1hrfix1$Min == 3)))), ]
...
# sbrs4allmtnwdistwater <- cbind(sbrs4allmtn1, sbrs4topodistall)
...
if(nrow(moveallrangetime1[(((moveallrangetime1$DateTimect >= all4mtndistwater1$DateTimeLocalTestct[row]) & (all4mtndistwater1$DateTimeLocalTestct[row] >= (moveallrangetime1$DateTimect - 14700))) & (moveallrangetime1$KI_Known_ID == all4mtndistwater1$IDs[row])), ]) >= 1){all4mtndistwater1$beforevisit[row] <- TRUE}
  }
...
fall4mtndistwater2 <- all4mtndistwater1[(((all4mtndistwater1$lagtime >= 3.95 & all4mtndistwater1$lagtime <= 4.05) | (is.na(all4mtndistwater1$lagtime) == TRUE)) & (((all4mtndistwater1$leadtime >= 3.95 & all4mtndistwater1$leadtime <= 4.05) | (is.na(all4mtndistwater1$leadtime) == TRUE)))), ]
```
...
## Checking normality
# Angle of movement
qqnorm(fall4mtndistwater2$positangledegree)
qqline(fall4mtndistwater2$positangledegree)
hist(fall4mtndistwater2$positangledegree)
# Have to use a Mann-Whitney U Test b/c nonparametric
wilcox.test(fall4mtndistwater2$positangledegree[fall4mtndistwater2$beforevisit == "TRUE"], fall4mtndistwater2$positangledegree[fall4mtndistwater2$beforevisit == "FALSE"])
# Step Length
qqnorm(fall4mtndistwater2$stplengthtopo)
qqline(fall4mtndistwater2$stplengthtopo)
hist(fall4mtndistwater2$stplengthtopo)
# Right skewed. Need to transform. Sqrt is still not perfect, but better.
hist(sqrt(fall4mtndistwater2$stplengthtopo))
t.test(sqrt(stplengthtopo) ~ beforevisit, data = fall4mtndistwater2)
# Super significant, unlike 1 hr fix rate
# Distance to water
qqnorm(fall4mtndistwater2$Closedist)
qqline(fall4mtndistwater2$Closedist)
hist(fall4mtndistwater2$Closedist)
hist(sqrt(fall4mtndistwater2$Closedist))
#Transforming to make it normal
t.test((sqrt(Closedist)) ~ beforevisit, data = fall4mtndistwater2)
# Angle of Movement Relative to Water
qqnorm(fall4mtndistwater2$angle2waterdegree)
qqline(fall4mtndistwater2$angle2waterdegree)
hist(fall4mtndistwater2$angle2waterdegree)
# Mann-Whitney U Test b/c nonparametric
wilcox.test(fall4mtndistwater2$angle2waterdegree[fall4mtndistwater2$beforevisit == "TRUE"], fall4mtndistwater2$angle2waterdegree[fall4mtndistwater2$beforevisit == "FALSE"])
# significantly different with wilcox and t.test
t.test(angle2waterdegree ~ beforevisit, data = fall4mtndistwater2)

## Linear Mixed Model
fall4mtndistwater2$scalepositangledegree <- scale(fall4mtndistwater2$positangledegree, center = TRUE, scale = TRUE)
fall4mtndistwater2$scalestplengthtopo <- scale(fall4mtndistwater2$stplengthtopo, center = TRUE, scale = TRUE)
fall4mtndistwater2$scaleClosedist <- scale(fall4mtndistwater2$Closedist, center = TRUE, scale = TRUE)
fall4mtndistwater2$scaleangle2waterdegree <- scale(fall4mtndistwater2$angle2waterdegree, center = TRUE, scale = TRUE)
bmovevizscal <- glmer(beforevisit ~ scalepositangledegree + scalestplengthtopo + scaleClosedist + scaleangle2waterdegree + (1|Date) + (1|IDs), data = fall4mtndistwater2, family = binomial(link = "logit"))
summary(bmovevizscal)
# If take out (1|Date), not singular, same fixed effects are significant. If take out (1|IDs), it is still singular
bmovevizscal <- glmer(beforevisit ~ scalepositangledegree + scalestplengthtopo + scaleClosedist + scaleangle2waterdegree + (1|IDs), data = fall4mtndistwater2, family = binomial(link = "logit"))
summary(bmovevizscal)
# Deleting scalepositangledegree THIS ONE IN PAPER 1/2/21
bmovevizscal1 <- glmer(beforevisit ~ scalestplengthtopo + scaleClosedist + scaleangle2waterdegree + (1|IDs), data = fall4mtndistwater2, family = binomial(link = "logit"))
summary(bmovevizscal1)

# Comparing only in the day. 
dayfall4mtndistwater2 <- fall4mtndistwater2
dayfall4mtndistwater2$Hour <- as.numeric(format(dayfall4mtndistwater2$DateTimeLocalTestct, "%H"))
dayfall4mtndistwater2$Min <- as.numeric(format(dayfall4mtndistwater2$DateTimeLocalTestct, "%M"))
# Subsetting to between 5 and 20 hours based on GPS data
day4hr <- dayfall4mtndistwater2[(((dayfall4mtndistwater2$Hour == 4) & (dayfall4mtndistwater2$Min == 59)) | ((dayfall4mtndistwater2$Hour == 20) & ((dayfall4mtndistwater2$Min == 0) | (dayfall4mtndistwater2$Min == 1) | (dayfall4mtndistwater2$Min == 2) | (dayfall4mtndistwater2$Min == 3))) | (dayfall4mtndistwater2$Hour == 7) | (dayfall4mtndistwater2$Hour == 8) | (dayfall4mtndistwater2$Hour == 12) | (dayfall4mtndistwater2$Hour == 16) | (dayfall4mtndistwater2$Hour == 19)), ]
day4hrmovevizscal <- glmer(beforevisit ~ scalepositangledegree + scalestplengthtopo + scaleClosedist + scaleangle2waterdegree + (1|IDs), data = day4hr, family = binomial(link = "logit"))
summary(day4hrmovevizscal)
AIC(day4hrmovevizscal)
BIC(day4hrmovevizscal)
# Removing scalepositangledegree
day4hrmovevizscal1 <- glmer(beforevisit ~ scalestplengthtopo + scaleClosedist + scaleangle2waterdegree + (1|IDs), data = day4hr, family = binomial(link = "logit"))
summary(day4hrmovevizscal1)
AIC(day4hrmovevizscal1)
BIC(day4hrmovevizscal1)
...
confint(day4hrmovevizscal1)

day4hrmovevizscal1 <- glmer(beforevisit ~ scalestplengthtopo + scaleClosedist + scaleangle2waterdegree +  (1|IDs), data = day4hr, family = binomial(link = "logit"))

## Comparing the models
library(AICcmodavg)
modelf <- list(day4hrmovevizscal, day4hrmovevizscal1)
modelnamesf <- c('4var', '3varnoangle')
bictab(cand.set = modelf, modnames = modelnamesf)

# Looking at a glm model because why not
temp <- glm(beforevisit ~ positangledegree + sqrt(stplengthtopo) + sqrt(Closedist) + angle2waterdegree, data = fall4mtndistwater2, family = "binomial")
summary(temp)

temp <- lm(beforevisit ~ positangledegree + stplengthtopo + Closedist + angle2waterdegree, data = fall4mtndistwater2)
summary(temp)

temp1 <- glm(beforevisit ~ scalepositangledegree + scalestplengthtopo + scaleClosedist + scaleangle2waterdegree, data = fall4mtndistwater2, family = "binomial")
# scaling shows what has more impact.
...
bmovevizscal1 <- glmer(beforevisit ~ scalestplengthtopo + scaleClosedist + scaleangle2waterdegree + (1|Date) + (1|ID), data = all4mtndistwater2, family = binomial(link = "logit"))
summary(bmovevizscal1)
# Deleting scaleClosedist
bmovevizscal2 <- glmer(beforevisit ~ scalestplengthtopo + scaleangle2waterdegree + (1|Date) + (1|ID), data = all4mtndistwater2, family = binomial(link = "logit"))
summary(bmovevizscal2)
# Deleting scaleangle2waterdegree
bmovevizscal3 <- glmer(beforevisit ~ scalestplengthtopo + (1|Date) + (1|ID), data = all4mtndistwater2, family = binomial(link = "logit"))
summary(bmovevizscal3)
# For 4-hr, only topographic step length is significant? Unlike 1 hr, where only distance to the closest water source is significant? 
```
Examining the 4 movement variables. If each variable is different by mountain range, individual, or month.
...
# Mapping dist water by month
par(mfrow = c(2,2))
boxplot(Closedist ~ Month, data = all4mtndistwater2[all4mtndistwater2$MountainRange == "Marb", ], ylab = "Distance (m)", main = "Marbles (n =10)", ylim = c(0, 16000))
boxplot(Closedist ~ Month, data = all4mtndistwater2[all4mtndistwater2$MountainRange == "BrsS", ], ylab = "Distance (m)", main = "South Bristols (n = 6)", ylim = c(0, 16000))
boxplot(Closedist ~ Month, data = all4mtndistwater2[all4mtndistwater2$MountainRange == "Nopa", ], ylab = "Distance (m)", main = "Nopah (n = 4)", ylim = c(0, 16000))
boxplot(Closedist ~ Month, data = all4mtndistwater2[all4mtndistwater2$MountainRange == "CMPR", ], ylab = "Distance (m)", main = "Castle Piute (n = 2)", ylim = c(0, 16000))
...
```
Checking difference in each variable individually different before coming into water or not
```{r}
t.test(sqrt(stplengthtopo) ~ beforevisit, data = all4mtndistwater2)
# Significantly different unlike at 1 hr fix rate
...
# Not significantly different unlike 1 hr fix rate
# t = -1.765, df = 370.24, p-value = 0.07839
# alternative hypothesis: true difference in means is not equal to 0
# 95 percent confidence interval:
# -5.7992965  0.3129979
# sample estimates:
