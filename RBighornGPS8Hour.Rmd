...
BIC(daybmovevizscal2)

## Comparing models
library(AICcmodavg)
modelsg <- list(daybmovevizscal, daybmovevizscal1, daybmovevizscal2)
modelnamesg <- c('4var', '3varnostplength', '2varClosedistAngletowater')
bictab(cand.set = modelsg, modnames = modelnamesg)
