...
jdistenvnew <- glm(MeanClosedist ~ scaledayl + scalesrad + scaletmin + scaletmax + scale6precip + scaledayl * scaletmin, data = jovenv, na.action = na.exclude)
summary(jdistenvnew)
