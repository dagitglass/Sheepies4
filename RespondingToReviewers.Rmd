...
xdistenvnew <- glm(MeanClosedist ~ dayl..s. + srad..W.m.2. + tmin..deg.c. + tmax..deg.c. +  vp..Pa. + MeanNDVI + Precip6Wk, data = xmovenv, na.action = na.exclude)
summary(xdistenvnew)
# R squared
with(summary(xdistenvnew), 1 - deviance/null.deviance)

# Minus vp
xdistenvnew1 <- glm(MeanClosedist ~ dayl..s. + srad..W.m.2. + tmin..deg.c. + tmax..deg.c. + MeanNDVI + Precip6Wk, data = xmovenv, na.action = na.exclude)
...
xdistenvnew2 <- glm(MeanClosedist ~ dayl..s. + srad..W.m.2. + tmin..deg.c. + tmax..deg.c. + Precip6Wk, data = xmovenv, na.action = na.exclude)
...
jdistenvnew <- glm(MeanClosedist ~ scaledayl + scalesrad + scaletmin + scaletmax + scalendvi + scale6precip, data = jovenv, na.action = na.exclude)
summary(jdistenvnew)
