...
# Selecting Models
library(AICcmodavg)
models <- list(prmd, prmd1, prmd2, prmds, dyl, vp)
model.names <- c('tmax.ndvi.tmin.precip.precip6.model', 'tmax.ndvi.tmin.precip6.model', 'tmax.ndvi.precip6.model', 'srad', 'dayl', 'vp')
