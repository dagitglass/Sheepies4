...
par(mar=c(4,5,3.9,1))
par(mfrow = c(2,2))
boxplot(Meannumvisits ~ Month, data = allindrd11[allindrd11$MtnRange == "Marb", ], main = (substitute(paste(bold('Marbles ('), bolditalic(n), bold(' = 31*)')))), ylab = "VTW/desert bighorn", ylim = c(0, 1.3), axes = F, col = "white")
box(bty="l")
axis(2)
axis(1, at = c(1, 2, 3, 4), labels = c("5", "6", "7", "8"))

boxplot(Meannumvisits ~ Month, data = allindrd11[allindrd11$MtnRange == "BrsS", ], main = substitute(paste(bold('South Bristols ('), bolditalic(n), bold(' = 24)'))), ylab = "VTW/desert bighorn", ylim = c(0, 1.3), axes = F, col = "white")
box(bty="l")
axis(2)
axis(1, at = c(1, 2, 3, 4), labels = c("5", "6", "7", "8"))
...
boxplot(Meannumvisits ~ Month, data = allindrd11[allindrd11$MtnRange == "CMPR", ], main = substitute(paste(bold('Castle Piutes('), bolditalic(n), bold(' = 4)'))), ylab = "VTW/desert bighorn", ylim = c(0, 1.3), axes = F, col = "white")
box(bty="l")
axis(2)
axis(1, at = c(1, 2, 3, 4), labels = c("5", "6", "7", "8"))
...
par(mar=c(4,5,3.9,1))
par(mfrow = c(2,2))
marbbplotvisit <- boxplot(VisitDuration ~ Month, data = marbrangetime1, main = "Marbles", ylab = "Visit duration (mins)", axes = F, col = "white")
box(bty="l")
axis(2)
axis(1, at = c(1, 2, 3, 4), labels = c("5", "6", "7", "8"))

sbrsplotvisit <- boxplot(VisitDuration ~ Month, data = sbrsrangetime1, main = "South Bristols", ylab = "Visit duration (mins)", axes = F, col = "white")
box(bty="l")
axis(2)
axis(1, at = c(1, 2, 3, 4), labels = c("5", "6", "7", "8"))
...
cmprplotvisit <- boxplot(VisitDuration ~ Month, data = cmprrangetime1, main = "Castle Piutes", ylab = "Visit duration (mins)", axes = F, col = "white")
box(bty="l")
axis(2)
axis(1, at = c(1, 2, 3, 4), labels = c("5", "6", "7", "8"))
...
boxplot(visitedP ~ Month, data = allindsheepvisitperday[allindsheepvisitperday$MtnRange == "Marb", ], main = substitute(paste(bold('Marbles ('), bolditalic(n), bold(' = 31*)'))), ylab = "Percent", ylim = c(0, 100), axes = F, col = "white")
box(bty="l")
axis(2)
axis(1, at = c(1, 2, 3, 4), labels = c("5", "6", "7", "8"))

boxplot(visitedP ~ Month, data = allindsheepvisitperday[allindsheepvisitperday$MtnRange == "BrsS", ], main = substitute(paste(bold('South Bristols ('), bolditalic(n), bold(' = 24)'))), ylab = "Percent", ylim = c(0, 100), axes = F, col = "white")
box(bty="l")
axis(2)
axis(1, at = c(1, 2, 3, 4), labels = c("5", "6", "7", "8"))
...
boxplot(visitedP ~ Month, data = allindsheepvisitperday[allindsheepvisitperday$MtnRange == "CMPR", ], main = substitute(paste(bold('Castle Piutes ('), bolditalic(n), bold(' = 4)'))), ylab = "Percent", ylim = c(0, 100), axes = F, col = "white")
box(bty="l")
axis(2)
axis(1, at = c(1, 2, 3, 4), labels = c("5", "6", "7", "8"))
