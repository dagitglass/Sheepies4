...
boxplot(visitedP ~ Month, data = allindsheepvisitperday[allindsheepvisitperday$MtnRange == "Marb", ], main = "Marbles (n = 31*)", ylab = "Percent", ylim = c(0, 100))
boxplot(visitedP ~ Month, data = allindsheepvisitperday[allindsheepvisitperday$MtnRange == "BrsS", ], main = "South Bristols (n = 24)", ylab = "Percent", ylim = c(0, 100))
boxplot(visitedP ~ Month, data = allindsheepvisitperday[allindsheepvisitperday$MtnRange == "Nopa", ], main = "Nopah (n = 6)", ylab = "Percent", ylim = c(0, 100))
boxplot(visitedP ~ Month, data = allindsheepvisitperday[allindsheepvisitperday$MtnRange == "CMPR", ], main = "Castle Piutes (n = 4)", ylab = "Percent", ylim = c(0, 100))
#title("Percent of Individual Sheep that Visited Water on a Given Day by Month", line = -1, outer = TRUE)
dev.off()
