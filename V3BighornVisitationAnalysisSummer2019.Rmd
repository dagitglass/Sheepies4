...
plot(percentvisitbyhour, type = "o", ylab = "Percent of Bighorn Visits by Hour", xlab = "Hour", main = "Percent of Bighorn Visits by Time of Day", axes = F)
box(bty="l")
axis(2)
axis(1)

par(mfrow=c(2,1), mar=c(1,1,1,1))
plot(percentvisitbyhour, type = "o", ylab = "Percent of bighorn visits by hour", xlab = "Hour")
...
par(mar=c(4,4,4,1))
par(mfrow = c(2,2))
marbbplotvisit <- boxplot(VisitDuration ~ Month, data = marbrangetime1, main = "Marble", ylab = "Visit duration (mins)", axes = F, col = "white")
box(bty="l")
axis(2)
axis(1, at = c(1, 2, 3, 4), labels = c("May", "Jun", "Jul", "Aug"))

sbrsplotvisit <- boxplot(VisitDuration ~ Month, data = sbrsrangetime1, main = "South Bristol", ylab = "Visit duration (mins)", axes = F, col = "white")
box(bty="l")
axis(2)
axis(1, at = c(1, 2, 3, 4), labels = c("May", "Jun", "Jul", "Aug"))

nopaplotvisit <- boxplot(VisitDuration ~ Month, data = noparangetime1, main = "Nopah", ylab = "Visit duration (mins)", axes = F, col = "white")
box(bty="l")
axis(2)
axis(1, at = c(1, 2, 3, 4), labels = c("May", "Jun", "Jul", "Aug"))

cmprplotvisit <- boxplot(VisitDuration ~ Month, data = cmprrangetime1, main = "Castle Piute", ylab = "Visit duration (mins)", axes = F, col = "white")
box(bty="l")
axis(2)
axis(1, at = c(1, 2, 3, 4), labels = c("May", "Jun", "Jul", "Aug"))
